    ...
    <div class="card p-4 shadow rounded" style="width: 100%; max-width: 500px;">
      ...
      <form action="index.php?page=update-user" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="nama_lengkap" id="nama_lengkap" value="<?=$user->nama_lengkap?>" class="form-control" required>
        </div>

        <div class="mb-3">
          <label for="role" class="form-label" value=<?=$user->role?>>Role</label>
